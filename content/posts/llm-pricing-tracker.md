...
This page tracks public pricing from official provider pages for major frontier-model vendors I regularly compare: OpenAI (GPT-5.6 Sol, Terra, and Luna), Google (Gemini 3.7 Flash and Gemma 4), Anthropic (including Claude Opus 5), xAI (Grok 4.6), DeepSeek V4, Qwen, Moonshot/Kimi (including Kimi K3), Xiaomi/MiMo, MiniMax, Together AI's GLM-5.2 endpoint, and GitHub Copilot.
